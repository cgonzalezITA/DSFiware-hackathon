...
[ "$VERBOSE" = true ] && echo "Phase 1- Retrieve an existing a Verifiable Credential (VC) from a VCIssuer (Keycloak in this use case)"
...
[ "$VERBOSE" = true ] && echo -e "\n*****\nexport VERIFIABLE_CREDENTIAL=$VERIFIABLE_CREDENTIAL" || echo $VERIFIABLE_CREDENTIAL;